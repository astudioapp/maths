...
<html>
    <head>
        ...
        <title>Square Root of """ + str(i) + """ | Equations | Astudio</title>
  ...
  gtag('config', 'G-ERNTS19CHC');
    ...
    <body onload="articleLoad();">
        <header class="nav-down">
            ...
            <a class="subjects" href="javascript:toggleSubject();"><div class="dot maths"></div><span>Maths</span></a>
        ...
        <div class="subjectBox">
            ...
            <a href="javascript:go('maths');" class="subjectItemLink selected"><div class="dot maths"></div><span class="subjectListItem">Maths</span></a>
        ...
        <main>
            <h1>The square root of """ + str(i) + """ (√""" + str(i) + """)</h1>
            <span>The square root of """ + str(i) + """ is <strong>""" + rootrounded + """</strong> to 3 significant figures.</span>
        </main>
    </body>
</html>"""
    f = open(str(i) + ".html", "w")
    ...
    sitemap = """
    <url>
        <loc>https://astudioapp.com/maths/equations/root/""" + str(i) + """.html</loc>
        <lastmod>2021-02-16T11:07:42+00:00</lastmod>
        <changefreq>monthly</changefreq>
    </url>
    """
    f = open("/mnt/e/local git/astudio/astudioapp.github.io/smp.xml", "a")
    f.write(sitemap)
    f.close()