...
<html>
    <head>
        ...
        <title>6th Root of """ + str(i) + """ | Equations | Astudio</title>
...
<script>
  ...
  gtag('config', 'G-ERNTS19CHC');
    ...
    <body onload="articleLoad();">
        ...
        <main>
            <h1>The 6th root of """ + str(i) + """</h1>
            <span>The 6th root of """ + str(i) + """ is <strong>""" + rootrounded + """</strong> to 2 decimal places.</span>
        </main>
    </body>
</html>"""
    f = open(str(i) + ".html", "w")
    ...
    sitemap = """
    <url>
        <loc>https://astudioapp.com/maths/equations/6throot/""" + str(i) + """.html</loc>
